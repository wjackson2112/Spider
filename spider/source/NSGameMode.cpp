...
void NSGameMode::animationCompleteWithId(std::string identifier, Entity *entity)
{
    ...
    if(dynamic_cast<CFCard*>(pilable)->getRank() == CF_RANK_KING)
    {
    ...
    {
        dynamic_cast<CFCard *>(pilable)->flip();
        return;
    }
